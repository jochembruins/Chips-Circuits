...
for i in range(0, 20):
    listelement1 = netlist_1[i][0]
    listelement2 = netlist_1[i][1]
    x_verschil = gate2[(listelement1 - 1).x] - gate2[(listelement2 - 1).x]
    y_verschil = gate2[(listelement1 - 1).y] - gate2[(listelement2 - 1).y]
